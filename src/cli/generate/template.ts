...
export function renderTemplate({
  ...
  const imports = [
    ...
    "import { createRuntime, createServerProxy } from 'craft-mcp-cli';",
    "import { createCallResult } from 'craft-mcp-cli';",
  ].join('\n');
  const embedded = JSON.stringify(definition, (_key, value) => (value instanceof URL ? value.toString() : value), 2);
  const generatorHeader = `Generated by ${generator.name}@${generator.version} — https://github.com/lukilabs/craft-mcp-cli`;
