...
export function printListHelp(): void {
  const lines = [
    'Usage: craft list [flags]',
    '',
    'Description:',
    '  Lists all Craft connections. Use "craft tools" to list tools for a connection.',
    '',
    'Flags:',
    '  --json                 Emit a JSON summary instead of text.',
    '',
    'Examples:',
    '  craft list              # List all Craft connections',
    '  craft tools             # List tools for default connection',
    '  craft tools <connection> # List tools for specific connection',
  ];
